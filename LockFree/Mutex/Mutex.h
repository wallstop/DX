...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
// DX LockFree - Mutex describes a mutex-like object for use with DX LockFree constructs
...
namespace LockFree {
    ...
    /*! \brief Mutex is a general descriptor for a class of objects that perform analagous to 
        actual Mutexes. However, their exact implementations and yielding behavior may vary.    
    */
    class Mutex
    {
    public:
